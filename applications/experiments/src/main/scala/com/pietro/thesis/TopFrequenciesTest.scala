...
object ClusterLocalMGSummaryTest {
  def main(args: Array[String]) {    
    ...
    val outputTopic = "realFrequencies"
    val outputBrokers = "sky1.it.kth.se:9092"
    ...
    /* Compute exact word frequency from input cluster data */
...
//	.option("truncate", "true")
    ...
    val toKafka = trueWordCount
        ...
        .option("checkpointLocation", "realFrequencies-chckpnt")
        .start()
